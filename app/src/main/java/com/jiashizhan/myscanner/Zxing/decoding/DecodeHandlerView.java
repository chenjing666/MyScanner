...
import com.jiashizhan.myscanner.Zxing.CaptureView;
import com.jiashizhan.myscanner.Zxing.camera.CameraManager;
import com.jiashizhan.myscanner.Zxing.camera.PlanarYUVLuminanceSource;

import java.util.Hashtable;

final class DecodeHandlerView extends Handler {
    ...
    DecodeHandlerView(CaptureView activity,
...
//		int quit = UZResourcesIDFinder.getResIdID("fn_quit");
        int decode = R.id.fn_decode;
        int quit = R.id.fn_quit;
...
//            int decode_succeeded = UZResourcesIDFinder.getResIdID("fn_decode_succeeded");
            ...
            Message message = Message.obtain(activity.getHandler(),
                    R.id.fn_decode_succeeded, rawResult);
